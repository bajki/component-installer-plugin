...
The required Composer plugin to handle with modules and components for Antares.

## Documentation

Documentation about how to use this plugin within Antares can be found in [antaresproject.io/docs/modules_development/module_base](http://antaresproject.io/docs/site/modules_development/module_base/index.html).
